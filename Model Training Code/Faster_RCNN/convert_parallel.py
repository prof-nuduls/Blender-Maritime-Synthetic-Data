...
def yolo_to_voc(yolo_path, voc_path, image_path, min_dimension=2):
    try:
...
for subfolder in subfolders:
    yolo_labels_path = os.path.join(yolo_base_path, subfolder, "labels")
    voc_annotations_path = os.path.join(faster_rcnn_base_path, subfolder, "annotations")
    images_path = os.path.join(faster_rcnn_base_path, subfolder, "images")
