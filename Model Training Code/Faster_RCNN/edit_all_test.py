...
python inference.py --input /SeaDronesSee\ Object\ Detection\ v2/Uncompressed\ Version/Test/images --model fasterrcnn_resnet50_fpn_v2 --weights ./outputs/training/{folder}_Faster_RCNN_v2_p30/best_model.pth --imgsz 1280 --output ./test_results --log-json"""
